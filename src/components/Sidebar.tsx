  ...
  return (
    <aside className="flex h-full w-[210px] shrink-0 flex-col bg-[#f6f6f7]">
      ...
      <div className="border-t border-divider px-4 py-3.5">
        <button className="flex w-full items-center gap-3 rounded-[10px] px-2 py-2 transition-colors hover:bg-black/[0.04]">
          ...
          <div className="flex flex-1 flex-col items-start">
            <span className="text-[13.5px] font-medium text-ink">Steve</span>
